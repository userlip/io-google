...
const getData = async(urlArg, id) => {
    try{
    const url = urlArg!=="undefined"? urlArg : `https://www.google.com/search?q=${ id!=="undefined"? id : "site:linkedin.com/in+'amazon.com'" }&gl=us`;
