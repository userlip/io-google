...
const getAuthorProfileData = async ( urlArg, id ) => {
  try {
    const url = urlArg!=="undefined"? urlArg : `https://scholar.google.com/citations?hl=en&user=${ id!=="undefined"? id : "cOsxSDEAAAAJ" }`;
...
getAuthorProfileData(args[2], args[3])